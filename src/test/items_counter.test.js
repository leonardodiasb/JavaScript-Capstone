...
describe('itemsCounter function', () => {
  test('Check if the amount of items counted in the API is the same amount the API provides', async () => {
    const APIdata = [{
      idMeal: '52767',
    ...
    expect(itemsCounter(APIdata)).toBe(32);
  });
});